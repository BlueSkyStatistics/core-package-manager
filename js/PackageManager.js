...
class PackageManager {
    ...
    async newSendSync(params) {
        try {
            ...
            ipcRenderer.invoke("log", {
                message: "newSendSync: result..." + result,
                source: "_PM",
    ...
    async createRpkgList() {
        try {
            ...
            ipcRenderer.invoke("log", {
                message: "createRpkgList: resultdata..." + data,
                source: "_PM",
                event: "updatePackages"
            })
            return data;
        ...
        switch (module.update) {
            case 'auto':
                if (gt(_remotePackage.version, _localPackage.version)) {
                    ...
                    ipcRenderer.invoke("log", {
                        message: `Remote version of ${module.name} is not greater than the local (when update:auto)`,
                        source: "_PM",
                        event: "updateOnePackages"
                    })
                }
                break
            case 'manual':
    ...
    async updatePackages() {
        ipcRenderer.invoke("log", {
            message: "updatePackages:before creating package list...",
            source: "_PM",
            event: "updatePackages"
        })
        ...
        if (sessionStore.get("installedPackages") == undefined) {
            ...
            ipcRenderer.invoke("log", {
                message: "updatePackages:ELSE installedPackages is already present...",
                source: "_PM",
                event: "updatePackages"
            })
        }
        ...
        ipcRenderer.invoke("log", {
            message: "updatePackages:after creating package list...",
            source: "_PM",
            event: "updatePackages"
        })
        ipcRenderer.invoke('status-message', {"message": "after creating package list..."})
        ipcRenderer.invoke("log", {
            message: "updatePackages:Checking for updates...",
            source: "_PM",
            event: "updatePackages"
        })
        ...
        for (var module of this.modules.core) {
            ...
            ipcRenderer.invoke("log", {
                message: "updatePackages:before core-updateOnePackage...",
                source: "_PM",
                event: "updatePackages"
            })
            await this.updateOnePackage(module)
            ipcRenderer.invoke("log", {
                message: "updatePackages.:after core-updateOnePackage...",
                source: "_PM",
                event: "updatePackages"
            })
        }
        for (const dialog of this.modules.dialogs) {
            ...
            ipcRenderer.invoke("log", {
                message: "updatePackages:before dialogs-updateOnePackage...",
                source: "_PM",
                event: "updatePackages"
            })
            await this.updateOnePackage(dialog)
            ipcRenderer.invoke("log", {
                message: "updatePackages:after dialogs-updateOnePackage...",
                source: "_PM",
                event: "updatePackages"
            })
        }
        ...
        ipcRenderer.invoke("log", {
            message: "updatePackages.:Update check is done ......",
            source: "_PM",
            event: "updatePackages"
        })
    ...
    async getPackagesVersions() {
        ...
        const process_package = async (package_item, additional_data = {}) => {
            ...
            if (configStore.get("offline")) {
                ...
                ipcRenderer.invoke("log", {
                    message: `getPackagesVersions: for ${package_item.name}`,
                    source: "_PM",
                    event: "_PM"
                })
